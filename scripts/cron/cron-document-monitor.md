# Archivo: /etc/cron.d/pipeline-document-mineduc

# Ejecutar diariamente a las 2 AM
0 2 * * * cd /opt/portafolio-docente/scripts/pipeline-document-mineduc && \
          /opt/portafolio-docente/venv/bin/python 00-monitor.py --auto \
          >> /var/log/pipeline-document-mineduc.log 2>&1

# Verificar cada hora si hay documentos pendientes de procesar (opcional)
0 * * * * cd /opt/portafolio-docente/scripts/pipeline-document-mineduc && \
